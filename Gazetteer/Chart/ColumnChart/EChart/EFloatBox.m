...
- (NSString *)makeString
{
    ...
    else
    {
        ...
        if (_unit)
        {
            finalText = [[NSString stringWithFormat:@"%@ ", _value] stringByAppendingString:_unit];
        }
        else
        {
            finalText = [NSString stringWithFormat:@"%@", _value];
        }
    }
